...
- (void)viewDidLoad {
    ...
    _dataArray = @[@[@"满屏填充",@"等边距自适应宽高",@"固定宽高居中",@"指定边距自适应宽高(不一定居中摆放)",@"等屏幕宽或高指定边距居中"],
                   @[@"固定宽高左上",@"固定宽高指定边距左上",@"固定宽高左中",@"固定宽高指定边距左中",@"固定宽高左下",@"固定宽高指定边距左下"],
                   @[@"固定宽高右上",@"固定宽高指定边距右上",@"固定宽高右中",@"固定宽高指定边距右中",@"固定宽高右下",@"固定宽高指定边距右下"],
                   @[@"固定宽高右上",@"固定宽高指定边距右上",@"固定宽高右中",@"固定宽高指定边距右中"],
                   @[@"定宽高外部左上",@"定宽高外部左中",@"定宽高外部左下",@"定宽高外部右上",@"定宽高外部右中",@"定宽高外部右下",@"定宽高外部上",@"定宽高外部下"]];
